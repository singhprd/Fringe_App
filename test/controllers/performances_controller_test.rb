...
class PerformancesControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post performances_url, params: { performance: { concession: @performance.concession, end: @performance.end, price: @performance.price, start: @performance.start } }
  #   end
  ...
  #   patch performance_url(@performance), params: { performance: { concession: @performance.concession, end: @performance.end, price: @performance.price, start: @performance.start } }
