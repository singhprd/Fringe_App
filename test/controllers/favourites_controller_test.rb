...
class FavouritesControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post favourites_url, params: { favourite: { event_id: @favourite.event_id, user_id: @favourite.user_id } }
  #   end
  ...
  #   patch favourite_url(@favourite), params: { favourite: { event_id: @favourite.event_id, user_id: @favourite.user_id } }
